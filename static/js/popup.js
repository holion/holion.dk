    ...
    var form_submit = function (e) {
        ...
        if (validate_form()) {
            ...
            async function submitForm() {
                ...
                const response = await fetch('https://holion.activehosted.com/proc.php?jsonp=true', {
                    headers: {
            ...
            if (formSupportsPost) {
                ...
                _load_script('https://holion.activehosted.com/proc.php?' + serialized + '&jsonp=true', null, true);
            }
        }
        return false;
    };
